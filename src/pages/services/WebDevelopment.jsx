      ...
      <main className="lg:w-3/4 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            We build stunning and functional websites that resonate with your
            audience. From front-end design to robust backend systems, our web
            solutions adapt as you grow. Your online presence becomes a true
            digital asset
          </p>
        </section>
        ...
        <div className="bg-[#1e2939] rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-2 list-disc list-inside text-gray-400">
            ...
            <li>Deployment & SEO Optimization</li>
          </ul>
        </div>
      </main>
    </div>
