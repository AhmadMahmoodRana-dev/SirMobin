      ...
      <main className="lg:w-3/4 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            We build robust enterprise software tailored to the unique workflows
            of your business. Whether CRM or ERP systems, our goal is to enhance
            efficiency and centralize your data. We collaborate to ensure every
            solution supports your long-term strategic objectives.
          </p>
        </section>
        ...
        <div className="bg-[#1e2939] rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-2 list-disc list-inside text-gray-400">
            <li>Custom CRM and ERP development</li>
        ...
        <div className="bg-[#1e2939] rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-2 list-disc list-inside text-gray-400">
            ...
            <li>Custom fit for operations</li>
