...
import { FaDesktop, FaPaintBrush, FaMobileAlt, FaCode, FaLaptopCode, FaServer,FaArrowRight } from 'react-icons/fa';
...
const serviceData = [
  {
    ...
    description: 'Explain to you how all this mistaken idea of denouncing pleasure born and give you complete.',
...
const ServiceCard = ({ service, index }) => {
  return (
    ...
    >
      ...
      <h3 className="text-white text-3xl font-bold mb-6 text-center">{service.title}</h3>
      <p className="text-[#ededed] mb-6 text-center text-[1.05rem]">{service.description}</p>
      <Link
        to={service.link}
    ...
    <section className="2xl:px-20 xl:px-6 lg:px-4 md:px-4 px-4 py-20 bg-[#1c1c1c]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-[#ededed] md:text-lg  max-w-2xl mx-auto">
