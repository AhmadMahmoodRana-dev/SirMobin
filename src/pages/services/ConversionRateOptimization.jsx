      ...
      <main className="lg:w-3/4 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Our CRO service focuses on turning more visitors into customers. By
            analyzing user behavior and testing variations of your pages, we
            help identify what works best. We refine your sales funnels and
            eliminate friction points to ensure your traffic translates into
            measurable results.
          </p>
        </section>
