      ...
      <main className="lg:w-3/4 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Your online reputation is your digital storefront. We monitor and
            manage how your brand is perceived across review sites, social
            media, and news platforms. By responding proactively and
            implementing positive PR strategies, we ensure your brand remains
        ...
        <div className="bg-[#1e2939] rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-2 list-disc list-inside text-gray-400">
            ...
            <li>Public relations and damage control</li>
        ...
        <div className="bg-[#1e2939] rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-2 list-disc list-inside text-gray-400">
            ...
            <li>Protects brand image</li>
            <li>Influences purchase decisions positively</li>
          </ul>
        </div>
        {/*Work Process*/}
